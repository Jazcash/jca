...
/*
TODO:
    - get IP and show flag icons?
    - distribute ammo to remaining allies when killed
    - 
*/
...
String @GT_ScoreboardMessage( uint maxlen )
{
    ...
    for ( t = TEAM_ALPHA; t < GS_MAX_TEAMS; t++ )
    {
        ...
        for ( i = 0; @team.ent( i ) != null; i++ )
        {
            ...
            {
                // "Name Clan Score Frags DG/DR Ping R"
                entry = 
                    "&p " + playerID + " " + 
                    ent.client.clanName + " " +
                    ent.client.stats.score + " " + 
...
void GT_InitGametype()
{
    ...
    {
        G_ConfigString( CS_SCB_PLAYERTAB_TITLES, "Name Clan Score Frags DG/DR Ping R" );
        G_ConfigString( CS_SCB_PLAYERTAB_LAYOUT, "%n 112 %s 50 %i 50 %i 40 %f 42 %l 38 %r l1" );
    }
